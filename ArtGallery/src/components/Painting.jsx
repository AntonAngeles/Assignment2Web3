            ...
            <div className="bg-blue-500 p-4 text-white rounded-lg md:col-span-2 flex flex-col">
                ...
                <div className="pt-4 flex items-center space-x-4">
                    <input
                        type="radio"
                        name="paintingFilter"
                        className="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white 
                        not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 
                ...
                {/* This is for the gallery filter */}
                <div className="pt-4 flex items-center space-x-4">
                    <input
                        type="radio"
                        name="paintingFilter"
                ...
                <div className="flex space-x-2">
                    <button className="bg-white px-3 py-1 text-black rounded-lg text-sm">Clear</button>
